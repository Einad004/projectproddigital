...
public class ViewBuscar extends javax.swing.JFrame {
    ...
    private void btnSiguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSiguienteActionPerformed
        ...
        if (e != null) {
            if (e instanceof Ebook) {
                ViewEbook vistaEbook = new ViewEbook((Ebook) e);
                vistaEbook.setVisible(true);
                this.dispose();
            }
            else if (e instanceof CursoOnline) {
                ViewCurso vistaCurso = new ViewCurso((CursoOnline) e);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ViewBuscar().setVisible(true));
    }
