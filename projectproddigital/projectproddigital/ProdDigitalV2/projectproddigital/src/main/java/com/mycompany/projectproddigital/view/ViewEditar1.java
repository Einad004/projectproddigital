 ...
 * @author Dhan
 */
public class ViewEditar1 extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ViewEditar1.class.getName());

    /**
     * Creates new form ViewEditar1
     */
    public ViewEditar1() {
        initComponents();
    ...
    private void btnSiguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSiguienteActionPerformed
        // 1. Buscamos el producto en tu base de datos o lista
        int codigo = Integer.parseInt(txtId.getText());
        ProductoDigital e = ProductoService.buscarPorCodigo(codigo);

        if (e != null) {
            // 2. Evaluamos el tipo de instancia
            if (e instanceof Ebook) {
                // Es un Ebook: Abrimos su vista específica
                ViewEditarEbook vistaEbook = new ViewEditarEbook((Ebook) e);
                vistaEbook.setVisible(true);
                this.dispose(); // Opcional: cierra la ventana actual
            } 
            else if (e instanceof CursoOnline) {
                // Es un Curso: Abrimos su vista específica
                ViewEditarCurso vistaCurso = new ViewEditarCurso((CursoOnline) e);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ViewEditar1().setVisible(true));
    }
